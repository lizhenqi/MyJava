...
<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b style="color: red">测试</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>凯盛</b>测试</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        ...
                                        <h4>
                                            技术团队
                                            <small><i class="icon-bell"></i> 5 mins</small>
                                        </h4>
                                        <!-- The message -->
                                        <p>为何不换一种图标？</p>
                                    </a>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start notification -->
                                    <a href="#">
                                        <i class="icon-plane"></i> 5 new members joined today
                                    </a>
                                </li>
                                <!-- end notification -->
                            </ul>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <%--<shiro:principal/>这个就是验证时候传进来的user对象--%>
                    </a>
                    <%--下拉菜单--%>
                    <ul class="dropdown-menu">
                        <li><a href="#">个人资料</a></li>
